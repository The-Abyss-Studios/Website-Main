      ...
      <section className="relative min-h-[40vh] flex items-center justify-center px-4">
        <div className="text-center z-10">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto">
            Be part of something extraordinary. Help us create the next generation of gaming experiences.
          </p>
        </div>
      </section>
            ...
            {[
              ...
              <div key={index} className="card group">
                ...
                <div className="relative bg-black/40 backdrop-blur-md rounded-xl p-8 border border-[#DC143C]/20 group-hover:border-[#DC143C]/40 transition-all duration-500">
                  ...
                  <h3 className="text-xl font-bold mb-4 bg-gradient-to-r from-[#DC143C] to-[#B01030] bg-clip-text text-transparent">
                    {benefit.title}
                  </h3>
              ...
              {jobPositions.map((job, index) => (
                <div
                  ...
                  className={`card group cursor-pointer ${
                    selectedJob === job ? 'ring-2 ring-[#DC143C]' : ''
                  }`}
                ...
                <div className="card">
                  ...
                  <div className="relative bg-black/40 backdrop-blur-md rounded-xl p-8 border border-[#DC143C]/20">
                    ...
                    <div className="space-y-8">
                      ...
                      <button
                        onClick={() => window.location.href = `/careers/apply?position=${encodeURIComponent(selectedJob.title)}`}
